...
func TestRecoverableDatabaseIDFormatter(t *testing.T) {
	actual := NewRecoverableDatabaseID("12345678-1234-9876-4563-123456789012", "resGroup1", "workspace1", "database1").ID()
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.Synapse/workspaces/workspace1/recoverableDatabases/database1"
	if actual != expected {
...
func TestRecoverableDatabaseID(t *testing.T) {
	testData := []struct {
		...
		{
			// valid
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.Synapse/workspaces/workspace1/recoverableDatabases/database1",
			Expected: &RecoverableDatabaseId{
